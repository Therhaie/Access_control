...
## ── import to check the health of the vllm server 
from query_piepline_modular import _check_vllm_health, check_vllm_embedding_ready
...
ORIGINAL_COLLECTION = COLLECTION  #"langchain"
DEFAULT_TOP_K       = 20
