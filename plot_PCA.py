...
COLLECTION_NAME_AUGMENTED = "augmented_db"
...
if __name__ == "__main__":
    ...
    method = "pca"  # Choose between "pca", "umap", or "tsne"
    save_path = os.path.join(SAVE_DIR, f"{method}_clusters_extra_dim.png")
    plot_pca(list_of_cluster_embeddings, title=f"Clusters representation using {method.upper()}, extra dim, seed : {SEED}", n_components=2, method=method, save_path=save_path)
    ...
    method = "tsne"  # Choose between "pca", "umap", or "tsne"
    save_path = os.path.join(SAVE_DIR, f"{method}_clusters_extra_dim.png")
    plot_pca(list_of_cluster_embeddings, title=f"Clusters representation using t-SNE, extra dim, seed : {SEED}", n_components=2, method=method, save_path=save_path)
